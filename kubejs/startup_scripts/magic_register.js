...
StartupEvents.registry("irons_spellbooks:spells", (event) => {
    event
        ...
        .setCastTime(10)
        .setBaseManaCost(2)
        .setCooldownSeconds(5) // Spell cooldown in seconds
        ...
        .canBeCraftedBy((player) => {
            if (player.level.clientSide) return false;
            return global.DRAGON_MAGIC.crafting(player);
        })
    ...
    event
        ...
        .setCastTime(120)
        .setBaseManaCost(100)
        .setCooldownSeconds(60) // Spell cooldown in seconds
        .setManaCostPerLevel(10) // How much additional mana is needed per level
